...
local UseAlternatePartyModels = true
local ChangeFinalFightsMusic = true

local kh2lib = require("kh2lib")
RequireKH2LibraryVersion(1)

local Now = kh2lib.Now
local Sve = kh2lib.Sve
local Save = kh2lib.Save
local ARDPointer = kh2lib.ARDPointer
local Music = kh2lib.Music
local Pause = kh2lib.Pause
local React = kh2lib.React
local Cntrl = kh2lib.Cntrl
local Timer = kh2lib.Timer
local Songs = kh2lib.Songs
local GScre = kh2lib.GScre
local GMdal = kh2lib.GMdal
local GKill = kh2lib.GKill
local CamTyp = kh2lib.CamTyp
local GamSpd = kh2lib.GamSpd
local CutNow = kh2lib.CutNow
local CutLen = kh2lib.CutLen
local CutSkp = kh2lib.CutSkp
local BtlTyp = kh2lib.BtlTyp
local BtlEnd = kh2lib.BtlEnd
local TxtBox = kh2lib.TxtBox
local DemCln = kh2lib.DemCln
local Slot1    = kh2lib.Slot1
local NextSlot = kh2lib.NextSlot
local Point1   = kh2lib.Point1
local NxtPoint = kh2lib.NxtPoint
local Gauge1   = kh2lib.Gauge1
local NxtGauge = kh2lib.NxtGauge
local Menu1    = kh2lib.Menu1
local NextMenu = kh2lib.NextMenu
local MSN = kh2lib.MSN
...
-- local Slot2  = Slot1 - NextSlot
-- local Slot3  = Slot2 - NextSlot
-- local Slot4  = Slot3 - NextSlot
-- local Slot5  = Slot4 - NextSlot
-- local Slot6  = Slot5 - NextSlot
-- local Slot7  = Slot6 - NextSlot
-- local Slot8  = Slot7 - NextSlot
-- local Slot9  = Slot8 - NextSlot
-- local Slot10 = Slot9 - NextSlot
-- local Slot11 = Slot10 - NextSlot
-- local Slot12 = Slot11 - NextSlot
-- local Point2 = Point1 + NxtPoint
-- local Point3 = Point2 + NxtPoint
-- local Gauge2 = Gauge1 + NxtGauge
-- local Gauge3 = Gauge2 + NxtGauge
local Menu2  = Menu1 + NextMenu
-- local Menu3  = Menu2 + NextMenu

local Obj0, Sys3, Btl0
